...
--
-- Name: conectar_corredores_escadas(integer, integer, numeric); Type: FUNCTION; Schema: public; Owner: indoor
--

CREATE FUNCTION public.conectar_corredores_escadas(bloco_id integer, andar_id integer, raio_maximo numeric) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    FOR waypoint_origem IN
        ...
        FROM waypoints
        WHERE tipo = 'corredor' AND bloco_id = bloco_id AND andar_id = andar_id
    LOOP
    ...
    -- Segundo: Conectar corredores com entradas de escadaria
    FOR waypoint_origem IN
        SELECT id, coordenadas
        FROM waypoints
        WHERE tipo = 'corredor' AND bloco_id = bloco_id AND andar_id = andar_id
    LOOP
        FOR waypoint_destino IN
            SELECT id, coordenadas
            FROM waypoints
            WHERE tipo = 'escadaria' AND bloco_id = bloco_id AND andar_id = andar_id
        LOOP
            distancia := ST_Distance(waypoint_origem.coordenadas, waypoint_destino.coordenadas);
...
ALTER FUNCTION public.conectar_corredores_escadas(bloco_id integer, andar_id integer, raio_maximo numeric) OWNER TO indoor;
...
--
-- Name: preencher_conexoes_bloco4_andar4(numeric); Type: FUNCTION; Schema: public; Owner: indoor
--

CREATE FUNCTION public.preencher_conexoes_bloco4_andar4(raio_maximo numeric) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    waypoint_origem RECORD;
...
ALTER FUNCTION public.preencher_conexoes_bloco4_andar4(raio_maximo numeric) OWNER TO indoor;
...
--
-- Name: preencher_conexoes_quarto_andar(numeric); Type: FUNCTION; Schema: public; Owner: indoor
--

CREATE FUNCTION public.preencher_conexoes_quarto_andar(raio_maximo numeric) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    waypoint_origem RECORD;
...
BEGIN
    -- Primeiro: Conectar apenas corredores entre si
    FOR waypoint_origem IN SELECT id, coordenadas FROM waypoints WHERE tipo = 'corredor' AND andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4) LOOP
        FOR waypoint_destino IN SELECT id, coordenadas FROM waypoints WHERE tipo = 'corredor' AND andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4) LOOP
            IF waypoint_origem.id <> waypoint_destino.id THEN
                distancia := ST_Distance(waypoint_origem.coordenadas, waypoint_destino.coordenadas);
    ...
    -- Segundo: Conectar corredores aos destinos finais (do 4º andar)
    FOR waypoint_origem IN SELECT id, coordenadas FROM waypoints WHERE tipo = 'corredor' AND andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4) LOOP
        FOR waypoint_destino IN SELECT waypoint_id AS id, (SELECT coordenadas FROM waypoints WHERE id = d.waypoint_id) AS coordenadas 
                                FROM destinos d 
                                WHERE waypoint_id IN (SELECT id FROM waypoints WHERE andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4)) LOOP
            distancia := ST_Distance(waypoint_origem.coordenadas, waypoint_destino.coordenadas);
    ...
    FOR waypoint_origem IN SELECT id, coordenadas FROM waypoints WHERE tipo = 'corredor' AND andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4) LOOP
        FOR waypoint_destino IN SELECT id, coordenadas FROM waypoints WHERE tipo = 'circulacao' AND andar_id = (SELECT id FROM andares WHERE bloco_id = 4 AND numero = 4) LOOP
            distancia := ST_Distance(waypoint_origem.coordenadas, waypoint_destino.coordenadas);
...
ALTER FUNCTION public.preencher_conexoes_quarto_andar(raio_maximo numeric) OWNER TO indoor;
...
125	Saida da escada - Granvia	Saída da escada para o 3º andar pela Granvia	408	Escadaria	07:00 - 23:00
Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000023FA73D901C14AC090225B2B14F238C0
487	Corredor 2	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000E748156201C14AC071139C9716F238C0
488	Corredor 3	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000E22C1D5A01C14AC0B0253F3D11F238C0
489	Corredor 4	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000412DC4F200C14AC0B1A5896F0FF238C0
490	Corredor 5	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000083A1926300C14AC0CF14B6760DF238C0
491	Corredor 6	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000030E7A5A4FFC04AC0EE7707FC0AF238C0
492	Corredor 7	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000DD2CB9E5FEC04AC00ED3C62A08F238C0
493	Corredor 8	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000096AABC36FEC04AC00FF3A3E905F238C0
494	Corredor 9	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000BA92B27FFDC04AC02E0E3EFF03F238C0
495	Corredor 10	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000A3C94951FCC04AC022E0CE8D02F238C0
496	Corredor 11	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000502902DEFAC04AC01D95177001F238C0
497	Corredor 12	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000000377A04EF9C04AC0A0D9D89900F238C0
498	Corredor 13	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000C3A00A87F7C04AC0A0D9D89900F238C0
499	Corredor 14	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000418FE602F6C04AC00BACCA5B01F238C0
500	Corredor 15	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000A108F368F4C04AC02EEAAC7902F238C0
501	Corredor 16	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000004839F306F3C04AC02EB219B703F238C0
502	Corredor 17	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000006D28CEB4F1C04AC00F2F80D704F238C0
503	Corredor 18	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000009DB6EB4AF0C04AC00FC9DAF005F238C0
504	Corredor 19	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000009D5D633CEFC04AC00E41FE6707F238C0
505	Corredor 20	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000EB0922BDEEC04AC0EFC93F0A09F238C0
506	Corredor 21	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000009368D71EEC04AC0EECFE2180BF238C0
507	Corredor 22	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E610000038AFFBD8EEC04AC0D08EC8350DF238C0
508	Corredor 23	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000CD63A449EFC04AC069B10C580FF238C0
509	Corredor 24	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000003E373CD6EFC04AC08CFF122311F238C0
510	Corredor 25	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000004F281B41F0C04AC020EF552B13F238C0
511	Corredor 26	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000004987E2E9F0C04AC0DDB5215215F238C0
512	Corredor 27	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000004F9CF58CF1C04AC03BFAA1CA17F238C0
513	Corredor 28	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000430DD751F2C04AC02E6C308119F238C0
514	Corredor 29	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000367EB816F3C04AC069A872561BF238C0
515	Corredor 30	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000713F3B3BF4C04AC0C2A13BB11CF238C0
516	Corredor 31	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000F93E45A3F5C04AC080223FB01DF238C0
517	Corredor 32	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000003A15DB6AF7C04AC07953F4341EF238C0
518	Corredor 33	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000A5473AA0F8C04AC0F1C37BED1DF238C0
519	Corredor 34	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000AAF6A75CFAC04AC08CF678211DF238C0
520	Corredor 35	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000918BBD59FBC04AC05100FF731CF238C0
521	Corredor 36	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000008B20297DFCC04AC051BE7F771BF238C0
522	Corredor 37	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000C0AEAA87FDC04AC0523000E01AF238C0
523	Corredor 38	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000001FA18756FEC04AC052C800161AF238C0
524	Corredor 39	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E61000002ACBAD9CFFC04AC070F7070419F238C0
525	Corredor 40	Corredor no 4º andar do Bloco 4	corredor	4	4	0101000020E6100000E23302BF00C14AC071B5880718F238C0
465	Saída da Escada do 3º Andar - Estacionamento	Saída da escada do 3º andar para o 4º andar - acesso Estacionamento	escada	4	4	0101000020E61000009116FC70EFC04AC00612B1140BF238C0
\.
...
SELECT pg_catalog.setval('public.conexoes_id_seq', 15629, true);
...
SELECT pg_catalog.setval('public.destinos_id_seq', 170, true);
...
SELECT pg_catalog.setval('public.waypoints_id_seq', 525, true);
