...
BEGIN
    -- Conectar corredores e áreas de circulação entre si (apenas no bloco 4)
    FOR waypoint_origem IN 
        SELECT id, coordenadas 
        FROM waypoints 
        WHERE bloco_id = 4 AND tipo IN ('corredor', 'circulacao') 
    LOOP
    ...
    -- Conectar corredores e áreas de circulação aos outros tipos de waypoints (exceto 'corredor' e 'circulacao', apenas no bloco 4)
    FOR waypoint_origem IN 
        SELECT id, coordenadas 
        FROM waypoints 
        WHERE bloco_id = 4 AND tipo IN ('corredor', 'circulacao') 
    LOOP
        FOR waypoint_destino IN 
            SELECT id, coordenadas 
            FROM waypoints 
            WHERE bloco_id = 4 AND tipo NOT IN ('corredor', 'circulacao') 
        LOOP
            distancia := ST_Distance(waypoint_origem.coordenadas, waypoint_destino.coordenadas);
    ...
    -- Conectar os outros tipos de waypoints de volta aos corredores e áreas de circulação (apenas no bloco 4)
    FOR waypoint_origem IN 
        SELECT id, coordenadas 
        FROM waypoints 
        WHERE bloco_id = 4 AND tipo NOT IN ('corredor', 'circulacao') 
...
60	Entrada da Repografia	Entrada da Repografia do Bloco 4	243	Sala	07:00 - 23:00
61	Entrada da Cozinha	Entrada da Cozinha do Bloco 4	244	Sala	07:00 - 23:00
62	Entrada do Laboratório de Nutrição	Entrada do Laboratório de Nutrição	245	Laborátorio	07:00 - 23:00
63	Entrada da Lanchonete do Bloco 4	Entrada da Lanchonete no Bloco 4	246	Lanchonete	07:00 - 23:00
69	Entrada da Sala dos Professores	Entrada da Sala dos Professores	252	Sala	07:00 - 23:00
71	Entrada Recepção B04	Entrada para a Recepção do Bloco 4	254	Sala	07:00 - 23:00
74	Entrada da Sala do CPD	Entrada da Sala do CPD	257	CPD	07:00 - 23:00
64	Entrada do Laboratório de Informática 5	Entrada do Laboratório de Informática 5	247	Laborátorio	07:00 - 23:00
65	Entrada do Laboratório de Informática 6	Entrada do Laboratório de Informática 6	248	Laborátorio	07:00 - 23:00
66	Entrada do Laboratório de Informática 7	Entrada do Laboratório de Informática 7	249	Laborátorio	07:00 - 23:00
67	Entrada do Auditório Bloco 4	Entrada do Auditório do Bloco 4	250	Auditorio	07:00 - 23:00
68	Entrada Sala Pós-graduação	Entrada da Sala de Pós-graduação	251	Sala	07:00 - 23:00
70	Entrada Múltiplas Salas Pequenas	Entrada para Múltiplas Salas Pequenas	253	Sala	07:00 - 23:00
72	Laboratório Informática Engenharia	Entrada do Laboratório de Informática para Engenharia	255	Laborátorio	07:00 - 23:00
73	Entrada do Laboratório de Informática	Entrada do Laboratório de Informática	256	Laborátorio	07:00 - 23:00
75	Entrada do Laboratório de Informática 1	Entrada do Laboratório de Informática 1	258	Laborátorio	07:00 - 23:00
76	Entrada do Laboratório de Informática 2	Entrada do Laboratório de Informática 2	259	Laborátorio	07:00 - 23:00
77	Entrada do Laboratório de Informática 3	Entrada do Laboratório de Informática 3	260	Laborátorio	07:00 - 23:00
78	Entrada do Laboratório de Informática 4	Entrada do Laboratório de Informática 4	261	Laborátorio	07:00 - 23:00
79	Entrada do Laboratório de Informática (escada estacionamento)	Entrada do Laboratório de Informática pelo acesso da escada do estacionamento	262	Laborátorio	07:00 - 23:00
80	Laboratório Informática Engenharia (escada estacionamento)	Entrada do Laboratório de Informática para Engenharia pelo acesso da escada do estacionamento	263	Laborátorio	07:00 - 23:00
\.
...
240	Escadaria - pelo acesso do estacionamento	Escadaria que dá acesso ao Bloco 4 pelo estacionamento	escadaria	4	1	0101000020E6100000A307DBDBEFC04AC090DFF49108F238C0
241	Escadaria - pelo acesso da granvia	Escadaria que dá acesso ao Bloco 4 pela Granvia	escadaria	4	1	0101000020E6100000D6849B2900C14AC04283241E16F238C0
...
243	Entrada da Repografia	Entrada da Repografia do Bloco 4	sala	4	1	0101000020E610000021CF8998EDC04AC03B033CCC0BF238C0
263	Laboratório Informática Engenharia (escada estacionamento)	Laboratório de Informática para Engenharia pela escada do estacionamento	sala	4	1	0101000020E6100000EAFB57F3EFC04AC03F64BAA50FF238C0
262	Entrada do Laboratório de Informática (escada estacionamento)	Entrada do Laboratório de Informática pela escada do estacionamento	sala	4	1	0101000020E6100000CC2190E8F1C04AC00F6DB6A805F238C0
261	Entrada do laboratório de informática 4	Entrada do Laboratório de Informática 4	sala	4	1	0101000020E61000002041759CF0C04AC09F85B14304F238C0
260	Entrada do laboratório de informática 3	Entrada do Laboratório de Informática 3	sala	4	1	0101000020E61000000D965E59F1C04AC09F4BC49D03F238C0
259	Entrada do laboratório de informática 2	Entrada do Laboratório de Informática 2	sala	4	1	0101000020E610000010D3B648F7C04AC04ED5DA87FEF138C0
258	Entrada do laboratório de informática 1	Entrada do Laboratório de Informática 1	sala	4	1	0101000020E61000000444980DF8C04AC0DDD330D7FDF138C0
257	Entrada da sala do CPD	Entrada da sala do CPD	sala	4	1	0101000020E610000019E3A2DEFCC04AC06D7EF434FDF138C0
256	Entrada do laboratório de informática	Entrada do Laboratório de Informática	sala	4	1	0101000020E6100000781EE40EFEC04AC0BEE802C901F238C0
255	Laboratório Informática Engenharia	Laboratório de Informática para Engenharia	sala	4	1	0101000020E6100000777087B8FFC04AC07F42A81808F238C0
254	Entrada Recepção B04	Entrada da Recepção do Bloco 4	sala	4	1	0101000020E610000024A8D02F00C14AC07EEC26DF09F238C0
253	Entrada Múltiplas Salas pequenas	Entrada para múltiplas salas pequenas	sala	4	1	0101000020E6100000EFEF852CFFC04AC030E939330BF238C0
252	Entrada da Sala dos Professores	Entrada da Sala dos Professores	sala	4	1	0101000020E6100000BDA04B5902C14AC04A7CCDF611F238C0
251	Entrada Sala Pós-graduação	Entrada da Sala de Pós-graduação	sala	4	1	0101000020E61000002B538A25FEC04AC0353732D118F238C0
250	Entrada do Auditório Bloco 4	Entrada do Auditório do Bloco 4	sala	4	1	0101000020E6100000C969573A02C14AC0F9BC24C619F238C0
249	Entrada do laboratório de informática 7	Entrada do laboratório de informática 7	sala	4	1	0101000020E610000021CE81EDF9C04AC014D44BE71EF238C0
248	Entrada do laboratório de informática 6	Entrada do laboratório de informática 6	sala	4	1	0101000020E61000007BFE3019F9C04AC0E4350AA41FF238C0
247	Entrada do laboratório de informática 5	Entrada do laboratório de informática 5	sala	4	1	0101000020E61000006A4CCAD5F6C04AC00D8D489021F238C0
246	Entrada da Lanchonete do Bloco 4	Entrada da Lanchonete do Bloco 4	sala	4	1	0101000020E61000004835AADBF2C04AC02B0407EE1FF238C0
245	Entrada do Laboratório de Nutrição	Entrada do Laboratório de Nutrição do Bloco 4	sala	4	1	0101000020E61000004987E2E9F0C04AC0F36D247D18F238C0
244	Entrada da Cozinha	Entrada da Cozinha do Bloco 4	sala	4	1	0101000020E6100000099E8C3BEFC04AC0B514D21212F238C0
...
SELECT pg_catalog.setval('public.conexoes_id_seq', 12834, true);
...
SELECT pg_catalog.setval('public.destinos_id_seq', 80, true);
...
SELECT pg_catalog.setval('public.waypoints_id_seq', 323, true);
